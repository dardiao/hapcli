...
class ComposeReleaseNotesTests(unittest.TestCase):
    def test_stable_notes_include_versioned_download_matrix(self) -> None:
        ...
        self.assertIn("hapcli_2.0.0_windows_x64-setup.exe", notes)
        self.assertIn("hapcli_2.0.0_macos_arm64.dmg", notes)
        self.assertIn("hapcli_2.0.0_linux_arm64.rpm", notes)
