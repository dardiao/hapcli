//! Stdio bridge for the optional hapcli Wasm runtime sidecar.
//!
...
#[cfg(windows)]
const WASM_SIDECAR_BINARY: &str = "hapcli-wasm-runtime.exe";
#[cfg(not(windows))]
const WASM_SIDECAR_BINARY: &str = "hapcli-wasm-runtime";
