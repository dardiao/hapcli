...
pub fn native_plugin_apply_oxide_import_core_with_progress<F>(
    store: &mut hapcli_connections::ConnectionStore,
    bytes: &[u8],
    password: &str,
...
pub fn native_plugin_apply_oxide_import_core(
    ...
    hapcli_connections::oxide_file::apply_oxide_import_with_options(
...
pub fn native_plugin_sync_connection_ids(
    connection_store: &hapcli_connections::ConnectionStore,
    args: &Value,
