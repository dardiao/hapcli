...
#[cfg(test)]
use hapcli_plugin_registry::NativePluginHostMonitorContribution;
use hapcli_plugin_registry::{
...
use hapcli_ssh::{NodeId, NodeRouter, SshCommandOutput};
...
mod tests {
    ...
    fn cached_host_tools_snapshot_exposes_remote_system_information() {
        ...
        let mut metrics = hapcli_connection_monitor::ResourceMetrics::empty(
            42,
            hapcli_connection_monitor::MetricsSource::Full,
        );
        metrics.system_info = Some(hapcli_connection_monitor::ResourceSystemInfo {
        ...
        registry.record_metrics(hapcli_connection_monitor::ProfilerUpdate {
