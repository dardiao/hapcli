...
use hapcli_backend_classification::{
...
use hapcli_sftp::{FileInfo, FileType, ListFilter, PreviewContent, SftpError, SftpSession};
use hapcli_ssh::{NodeId, NodeRouter, RouteError};
                    ...
                    let entries = sftp
                        .list_dir(
                            ...
                            Some(ListFilter {
                                show_hidden: true,
                                pattern: None,
                                sort: hapcli_sftp::SortOrder::Name,
                            }),
                        )
                        .await
                        .map_err(map_sftp_error)?;
