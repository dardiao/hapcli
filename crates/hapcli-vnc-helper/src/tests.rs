...
fn remote_monitor_layout_normalizes_negative_coordinates_for_rfb() {
    let layout = hapcli_remote_desktop::RemoteDesktopMonitorLayout {
        monitors: vec![
...
fn initial_desktop_layout_honors_use_all_monitors() {
    ...
    let monitors = hapcli_remote_desktop::RemoteDesktopMonitorLayout {
        monitors: vec![
...
fn remote_monitor_layout_rejects_primary_overlap_and_framebuffer_limit() {
    let no_primary = hapcli_remote_desktop::RemoteDesktopMonitorLayout {
    ...
    let multiple_primary = hapcli_remote_desktop::RemoteDesktopMonitorLayout {
        monitors: vec![
    ...
    let overlapping = hapcli_remote_desktop::RemoteDesktopMonitorLayout {
        monitors: vec![
...
fn remote_monitor(
    ...
    height: u32,
    primary: bool,
) -> hapcli_remote_desktop::RemoteDesktopMonitor {
    hapcli_remote_desktop::RemoteDesktopMonitor {
        ...
        orientation: hapcli_remote_desktop::RemoteDesktopMonitorOrientation::Landscape,
    }
}
