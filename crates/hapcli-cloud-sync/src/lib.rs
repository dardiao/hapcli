...
//! `com.hapcli.cloud-sync` plugin. Keep this crate UI-free so format
...
pub const CLOUD_SYNC_PLUGIN_ID: &str = "com.hapcli.cloud-sync";

pub const OXIDE_CONTENT_TYPE: &str = "application/vnd.hapcli.oxide";
pub const STRUCTURED_MANIFEST_FORMAT: &str = "structured-v1";
pub const STRUCTURED_MANIFEST_CONTENT_TYPE: &str =
    "application/vnd.hapcli.cloud-sync.manifest+json";
