...
fn setup(args: PortablePasswordArgs) -> CliResult<()> {
    ...
    hapcli_portable_runtime::keystore::create_portable_keystore(password.as_str())
...
fn unlock(args: PortablePasswordArgs) -> CliResult<()> {
    ...
    let password =
        read_single_password(args.password_stdin, args.password_env.as_deref(), args.json)?;
    hapcli_portable_runtime::keystore::unlock_portable_keystore(password.as_str())
...
fn change_password(args: PortableChangePasswordArgs) -> CliResult<()> {
    ...
    hapcli_portable_runtime::keystore::change_portable_keystore_password(
...
fn reset(args: PortableResetArgs) -> CliResult<()> {
    ...
    hapcli_portable_runtime::keystore::delete_portable_keystore()
