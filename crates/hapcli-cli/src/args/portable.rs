...
#[derive(Debug, Args)]
#[command(long_about = "Inspect and manage hapcli's portable runtime keystore.")]
#[command(
    after_help = "Examples:\n  hapcli portable status --json\n  printf '%s' \"$PORTABLE_PASSWORD\" | hapcli portable setup --password-stdin\n  hapcli portable unlock --password-env hapcli_PORTABLE_PASSWORD\n  hapcli portable change-password --current-password-env OLD --new-password-env NEW"
)]
