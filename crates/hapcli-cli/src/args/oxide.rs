...
#[command(
    after_help = "Examples:\n  hapcli oxide validate ./profile.oxide\n  hapcli oxide preview-import ./profile.oxide --password-stdin --json\n  hapcli oxide import ./profile.oxide --strategy merge --import-portable-secrets --yes\n  hapcli oxide export ./profile.oxide --connection prod --include-portable-secrets --password-env OXIDE_PASSWORD\n  hapcli oxide export ./profile.oxide --no-plugin-settings --overwrite"
)]
