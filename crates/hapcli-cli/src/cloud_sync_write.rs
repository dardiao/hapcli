...
use hapcli_forwarding::{ForwardingRegistry, SavedForwardStore};
use hapcli_settings::SettingsStore;
use serde::Serialize;
...
struct LegacyPullApplyResult {
    remote_metadata: hapcli_cloud_sync::backend::RemoteMetadata,
...
fn apply_pull_preview(
    ...
    settings: &hapcli_cloud_sync::CloudSyncSettings,
...
fn summary_from_local(
    local: &hapcli_cloud_sync::service::CloudSyncLocalSnapshot,
    remote_revision: Option<String>,
