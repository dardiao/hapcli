...
use hapcli_settings::ALL_OXIDE_SETTINGS_SECTIONS;
use serde::Serialize;
...
struct ReportBundleCloudSync {
    ...
    failed_history: Vec<hapcli_cloud_sync::state::CloudSyncHistoryEntry>,
...
mod tests {
    ...
    fn cloud_sync_report_counts_failed_history_without_secret_values() {
        ...
        state
            .sync_history
            .push(hapcli_cloud_sync::state::CloudSyncHistoryEntry {
                id: "history-1".to_string(),
                action: "upload".to_string(),
                timestamp: "2026-05-26T00:00:00Z".to_string(),
                success: false,
                summary: hapcli_cloud_sync::state::CloudSyncHistorySummary::default(),
