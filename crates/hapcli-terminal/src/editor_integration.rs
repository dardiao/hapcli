...
pub const VIM_FREE_TYPE_INTEGRATION_SOURCE: &str =
    include_str!("editor_integration/hapcli-free-type.vim");
pub const EMACS_FREE_TYPE_INTEGRATION_SOURCE: &str =
    include_str!("editor_integration/hapcli-free-type.el");
...
mod tests {
    ...
    fn bundled_editor_integrations_gate_the_private_protocol() {
        ...
        assert!(VIM_FREE_TYPE_INTEGRATION_SOURCE.contains("hapcli_PRIVATE_OSC"));
        assert!(EMACS_FREE_TYPE_INTEGRATION_SOURCE.contains("hapcli_PRIVATE_OSC"));
