...
mod tests {
    ...
    fn shell_probe_output_parses_nul_records() {
        let output = "noise\nhapcli_GIT_PROBE_V1\0state\0repo\0root\0/tmp/Oxide Term\0branch\0feat/git\0status\0# branch.upstream origin/feat\n# branch.ab +1 -0\n? scratch.txt\n\0operation\0merge\0";
    ...
    fn shell_probe_output_accepts_identity_without_status() {
        let output =
            "hapcli_GIT_PROBE_V1\0state\0repo\0root\0/repo\0branch\0main\0operation\0rebase\0";
        let outcome = parse_shell_probe_output(output);
    ...
    fn shell_probe_output_handles_not_repo() {
        let output = "hapcli_GIT_PROBE_V1\0state\0not_repo\0";
        assert_eq!(
    ...
    fn branch_list_output_attaches_worktree_paths() {
        let outcome = interpret_git_branch_list_outputs(
            ...
            GitCommandOutput::success(
                "worktree /Users/dominical/Documents/hapcli\n\
                 HEAD 1111111\n\
                 branch refs/heads/experiment/rust-native-v2\n\
                 \n\
                 worktree /Users/dominical/Documents/hapcli-main\n\
                 HEAD 2222222\n\
        ...
        assert_eq!(
            ...
            vec![
                GitBranchReference::with_worktree_path(
                    "experiment/rust-native-v2",
                    true,
                    Some("/Users/dominical/Documents/hapcli"),
                )
                .unwrap(),
                GitBranchReference::with_worktree_path(
                    "main",
                    false,
                    Some("/Users/dominical/Documents/hapcli-main"),
                )
                .unwrap(),
            ]
        );
    ...
    fn shell_branch_list_output_parses_branches() {
        let output = "noise\nhapcli_GIT_BRANCH_LIST_V1\0state\0ok\0branch\0main\0current\01\0branch\0feature/x\0current\00\0worktree\0feature/x\0path\0/tmp/feature-x\0";
    ...
    fn shell_branch_list_output_ignores_submodule_git_admin_paths() {
        let output = "hapcli_GIT_BRANCH_LIST_V1\0state\0ok\0branch\0master\0current\01\0worktree\0master\0path\0/repo/.git/modules/vendor/child\0";
    ...
    fn shell_probe_output_parses_git_file_worktree_operation() {
        let output = "hapcli_GIT_PROBE_V1\0state\0repo\0root\0/repo-linked\0branch\0feature/worktree\0operation\0merge\0";
    ...
    fn shell_staged_diff_output_parses_nul_records() {
        let output = "noise\nhapcli_GIT_STAGED_DIFF_V1\0state\0ok\0stat\0 src/lib.rs | 1 +\0patch\0diff --git a/src/lib.rs b/src/lib.rs\n+added\n\0";
    ...
    fn shell_staged_diff_output_handles_empty_state() {
        assert_eq!(
            parse_shell_staged_diff_output("hapcli_GIT_STAGED_DIFF_V1\0state\0empty\0"),
            GitStagedDiffOutcome::Empty
        );
    }
}
