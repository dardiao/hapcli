...
pub const SHELL_PROBE_SENTINEL: &str = "hapcli_GIT_PROBE_V1";
pub const SHELL_BRANCH_LIST_SENTINEL: &str = "hapcli_GIT_BRANCH_LIST_V1";
pub const SHELL_STAGED_DIFF_SENTINEL: &str = "hapcli_GIT_STAGED_DIFF_V1";
...
fn shell_branch_list_body() -> &'static str {
    concat!(
        "GIT_OPTIONAL_LOCKS=0; export GIT_OPTIONAL_LOCKS\n",
        "printf 'hapcli_GIT_BRANCH_LIST_V1\\0'\n",
        "if ! command -v git >/dev/null 2>&1; then printf 'state\\0git_missing\\0'; exit 0; fi\n",
...
fn shell_staged_diff_body() -> &'static str {
    concat!(
        "GIT_OPTIONAL_LOCKS=0; export GIT_OPTIONAL_LOCKS\n",
        "printf 'hapcli_GIT_STAGED_DIFF_V1\\0'\n",
        "if ! command -v git >/dev/null 2>&1; then printf 'state\\0git_missing\\0'; exit 0; fi\n",
        "git rev-parse --show-toplevel >/dev/null 2>&1 || { printf 'state\\0not_repo\\0'; exit 0; }\n",
