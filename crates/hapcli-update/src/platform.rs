...
mod tests {
    ...
    fn flavor_inference_covers_supported_install_shapes() {
        assert_eq!(
            InstallFlavor::infer(
                ...
                Path::new("C:/Users/me/hapcli/hapcli-native.exe"),
                false,
            ),
        ...
        assert_eq!(
            InstallFlavor::infer(
                &PlatformTarget::new("linux", "x86_64"),
                Path::new("/opt/hapcli/hapcli-native"),
                false,
            ),
        ...
        assert_eq!(
            InstallFlavor::infer(
                ...
                Path::new("/Applications/hapcli.app/Contents/MacOS/hapcli-native"),
                true,
            ),
    ...
    fn rpm_marker_selects_rpm_install_flavor() {
        ...
        let executable = directory.path().join("hapcli-native");
