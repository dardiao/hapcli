...
use hapcli_settings::UpdateChannel;

pub const STABLE_UPDATE_ENDPOINT: &str =
    "https://github.com/AnalyseDeCircuit/hapcli/releases/latest/download/latest.json";
pub const BETA_UPDATE_ENDPOINT: &str =
    "https://github.com/AnalyseDeCircuit/hapcli/releases/download/updater-beta/latest.json";
pub const GPUI_PREVIEW_UPDATE_ENDPOINT: &str = "https://github.com/AnalyseDeCircuit/hapcli/releases/download/updater-gpui-preview/latest.json";
