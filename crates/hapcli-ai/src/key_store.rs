...
const AI_KEYCHAIN_SERVICE: &str = "com.hapcli.ai";
#[cfg(target_os = "macos")]
const AI_KEYCHAIN_AUTHENTICATION_REASON: &str = "hapcli needs to access your AI API key";
...
impl AiProviderKeyStore {
    ...
    pub fn get_provider_keys(
        ...
        #[cfg(target_os = "macos")]
        {
            hapcli_secret_store::authenticate_device_owner(AI_KEYCHAIN_AUTHENTICATION_REASON)
...
fn portable_keychain_enabled() -> Result<bool> {
    hapcli_portable_runtime::is_portable_mode()
        .context("failed to determine hapcli portable mode")
}
