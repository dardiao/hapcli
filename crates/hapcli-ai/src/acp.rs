...
/// Detects hapcli's native Claude Code adapter, which learns the resolved model from the
...
/// Detects hapcli's native Codex adapter, which publishes its model choices during
...
pub fn build_acp_initialize_request(
    ...
    InitializeRequest::new(ProtocolVersion::V1)
        ...
        .client_info(Implementation::new("hapcli", client_version))
}
...
fn ensure_acp_v1_initialize_response(
    ...
    if response.protocol_version == ProtocolVersion::V1 {
        ...
        // hapcli's ACP client surface is defined for v1; continuing after a
