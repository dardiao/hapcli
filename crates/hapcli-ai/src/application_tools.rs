        ...
        tool(
            ...
            json!({
                ...
                "properties": {
                    ...
                    "scope_id": { "type": "string", "maxLength": MAX_IDENTIFIER_CHARS, "description": "Optional explicit scope identity. When omitted, hapcli resolves the current user, workspace, project, or host." },
