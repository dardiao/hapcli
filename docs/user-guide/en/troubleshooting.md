...
- Device busy: close other terminal programs, debuggers, flashing tools, or hapcli tabs that may already hold the port.
...
```sh
hapcli report --bundle ./hapcli-report.json --json
```
