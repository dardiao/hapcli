...
REPOSITORY_RELEASE_URL = "https://github.com/AnalyseDeCircuit/hapcli/releases/download"
...
def stable_download_table(version: str, tag: str) -> str:
    ...
    filenames = {
        "windows_x64": f"hapcli_{version}_windows_x64-setup.exe",
        "windows_arm64": f"hapcli_{version}_windows_arm64-setup.exe",
        "macos_x64": f"hapcli_{version}_macos_x64.dmg",
        "macos_arm64": f"hapcli_{version}_macos_arm64.dmg",
        "linux_x64_appimage": f"hapcli_{version}_linux_x64.AppImage",
        "linux_x64_deb": f"hapcli_{version}_linux_x64.deb",
        "linux_x64_rpm": f"hapcli_{version}_linux_x64.rpm",
        "linux_arm64_appimage": f"hapcli_{version}_linux_arm64.AppImage",
        "linux_arm64_deb": f"hapcli_{version}_linux_arm64.deb",
        "linux_arm64_rpm": f"hapcli_{version}_linux_arm64.rpm",
    }
